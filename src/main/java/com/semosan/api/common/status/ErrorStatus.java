...
public enum ErrorStatus implements BaseStatus {
    ...
    TRANSPORTATION_NOT_FOUND(HttpStatus.NOT_FOUND, "ADM_404_3", "교통정보를 찾을 수 없습니다."),
    ADMIN_COURSE_SUMMIT_INDEX_INVALID(HttpStatus.BAD_REQUEST, "ADM_400_1", "정상 지점 인덱스가 좌표 범위를 벗어났습니다."),
    ADMIN_COURSE_IN_USE(HttpStatus.CONFLICT, "ADM_409_1", "등산 기록·리뷰 등이 연결된 코스는 삭제할 수 없습니다.");
