...
public enum SuccessStatus implements BaseStatus {
    ...
    MOUNTAIN_LIKE_TOGGLE_SUCCESS(HttpStatus.OK, "MTN_200_4", "산 좋아요 처리에 성공했습니다."),
    ...
    FREE_POST_UPDATE_SUCCESS(HttpStatus.OK, "FPOST_200_6", "자유게시판 게시글이 수정되었습니다."),
    ...
    ADMIN_MOUNTAIN_LIST_SUCCESS(HttpStatus.OK, "ADM_200_15", "관리자 산 목록 조회에 성공했습니다."),
    ADMIN_MOUNTAIN_DETAIL_SUCCESS(HttpStatus.OK, "ADM_200_16", "관리자 산 상세 조회에 성공했습니다."),
    ...
    ADMIN_COURSE_SUMMIT_UPDATE_SUCCESS(HttpStatus.OK, "ADM_200_18", "코스 정상 좌표 반영에 성공했습니다."),
